...
TEXTS = {
    "el": {
        ...
        "markup_hint": "Κάντε κλικ πάνω στην εικόνα για να σημειώσετε ένα σημείο και γράψτε τι θέλετε να αλλάξει εκεί.",
        "markup_placeholder": "Τι να αλλάξει σε αυτό το σημείο;",
        "markup_remove": "Αφαίρεση",
        "open_full": "Άνοιγμα σε πλήρες μέγεθος",
    ...
    "en": {
        ...
        "markup_hint": "Click on the image to mark a spot and write what you would like changed there.",
        "markup_placeholder": "What should change at this spot?",
