...
export const PLANS_COMPARISON_LIST: TPlansComparisonDetails[] = [
    ...
    features: [
      {
        ...
        description:
          `Track progress in cycles, modules, and overviews\nthroughout ${brandName()} without switching to dashboards\nor Analytics.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      // },
      {
        title: "PQL",
        description:
          `Write ${brandName()} Query Language in search with support\nfor Boolean operators. Soon, you can write natural\nlanguage queries.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
    ...
    features: [
      {
        title: "GitHub",
        description:
          `Sync ${brandName()} work items and states to GitHub work items and\nstates. Update GitHub automatically with activity\nfrom ${brandName()} and vice-versa.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Slack",
        description: `Get ${brandName()} activity in Slack and use / commands in\nSlack to make changes in ${brandName()}.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Zendesk",
        description: `Create ${brandName()} work items from Zendesk tickets.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      {
        title: "Freshdesk",
        description: `Create ${brandName()} work items from Freshdesk tickets.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          `Choose other domains that can authenticate into\nyour ${brandName()} workspace or restrict all but one domain.`,
        cloud: {
          free: false,
          one: false,
          pro: true,
      ...
      },
      {
        ...
        description: `Secure your ${brandName()} workspace with device-\ndependent two-factor authentication and passkeys. `,
        cloud: {
          free: false,
          one: false,
          pro: true,
  ...
  },
  {
    ...
    features: [
      {
        title: "God Mode",
        description: `Manage your self-hosted ${brandName()} instance better with\nan instance admin interface.`,
        cloud: {
          free: true,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: `Install and deploy your self-hosted ${brandName()} to any\nprivate cloud with a single-line command.`,
        cloud: {
          free: false,
          one: true,
          pro: true,
      ...
      },
      {
        ...
        description: (
          <>
            ...
            <a href={`${brandHelpUrl()}`} target="_blank" rel="noopener noreferrer" className="underline">
              can be requested
            </a>
            .
          </>
